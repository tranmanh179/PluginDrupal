...
namespace Drupal\erp_user_dashboard\Plugin\views\style;
 ...
 *
 * @ViewsStyle(
 *   id = "erp_user_dashboard",
 *   title = @Translation("User Dashboard"),
 *   help = @Translation("User Dashboard for ERP"),
 *   theme = "erp_user_dashboard_dashboard",
 *   display_types = { "normal" }
 * )
 */
class Dashboard extends StylePluginBase {
  ...
  protected function defineOptions() {
    ...
    $options['path'] = array('default' => 'dashboard');
    return $options;
  }
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['path'] = array(
      '#type' => 'textfield',
      '#title' => t('Link path'),
      '#default_value' => (isset($this->options['path'])) ? $this->options['path'] : 'dashboard',
